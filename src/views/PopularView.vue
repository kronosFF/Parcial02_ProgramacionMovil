<template>
    <div class="container mb-2 body">
        ...
        <div class="row justify-content-center">
            <div class="col col-sm-2 col-md-2 col-lg-3 justify-content-center" v-for="lista in popoular" :key="lista.id">
...
export default {
    ...
    async created() {
        ...
        this.popoular = await getPopularMovies(this.id);
    },
    ...
    methods: {
        ...
        totalPages() {
            ...
            return Math.ceil(this.popoular.length / this.elemntsForPage)
        },
        ...
        getDataPage(pageNumber) {
            ...
            this.paginated_data = this.popoular.slice(init, end)
        },
